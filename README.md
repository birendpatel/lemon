...
- [ ] Write graph unit tests (VERY EASY) (map units tests must be done first)
...
- [ ] Update thread IDs in xerror (MEDIUM)
- [ ] Phase out remaining xerror codes and unused exceptions (HARD)
